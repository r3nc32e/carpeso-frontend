      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-gray-50 p-8">
        <div className="w-full max-w-md">
          ...
          <div className="flex items-center justify-center mb-6 gap-3">
            <div
              className={`flex items-center justify-center w-8 h-8 rounded-full text-sm font-bold ${step === "login" ? "bg-red-600 text-white" : "bg-green-500 text-white"}`}
            >
              {step === "login" ? "1" : "✓"}
            </div>
            <div
              className={`h-1 w-16 rounded ${step === "otp" ? "bg-red-600" : "bg-gray-200"}`}
            />
            <div
              className={`flex items-center justify-center w-8 h-8 rounded-full text-sm font-bold ${step === "otp" ? "bg-red-600 text-white" : "bg-gray-200 text-gray-400"}`}
            >
              2
            </div>
          </div>
