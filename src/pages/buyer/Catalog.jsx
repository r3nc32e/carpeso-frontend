    ...
    return (
        <div className="space-y-4">
            ...
            <div>
                ...
                <p className="text-sm text-gray-400">{vehicles.length} vehicles available</p>
            </div>
                        ...
                        <div key={v.id}
                            ...
                            <div className="p-4">
                                <div className="flex items-start justify-between mb-2">
                                    ...
                                    <span className={`px-2 py-1 rounded-full text-xs font-bold ${v.status === 'AVAILABLE' ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-500'}`}>
                                        {v.status}
                                    </span>
                                </div>
                                <div className="flex items-center justify-between mt-3">
                                    ...
                                    <div className="flex gap-2">
                                        <button
                                            onClick={() => { setSelected(v); setShowModal(true); }}
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                {[
                                    ...
                                    { label: 'Condition', value: selected.condition?.replace(/_/g, ' ') || '—' },
                                    { label: 'Fuel Type', value: selected.fuelType || '—' },
                                    { label: 'Transmission', value: selected.transmission || '—' },
                                    { label: 'Mileage', value: selected.mileage ? `${selected.mileage.toLocaleString()} km` : '—' },
                                    { label: 'Warranty', value: selected.warrantyYears ? `${selected.warrantyYears} year(s)` : '—' },
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md">
                        ...
                        <div className="p-6 space-y-4">
                            <div className="bg-gray-50 rounded-xl p-3">
                                <p className="font-bold text-gray-800">{selected.brand} {selected.model}</p>
                                <p className="text-sm text-gray-500">{selected.year} • ₱{Number(selected.price).toLocaleString()}</p>
                            </div>
