  ...
  const navItems = [
    {
      ...
      icon: <Star size={18} />,
      path: "/admin/reviews",
      show: hasPrivilege("CONTENT_MODERATOR") || isSuperAdmin,
    },
    {
      label: "Overview",
      ...
      >
        ...
        {sidebarOpen && (
          <div className="px-4 py-3 border-b border-red-500">
            ...
            <span
              className={`text-xs px-2 py-0.5 rounded-full font-semibold uppercase ${isSuperAdmin ? "bg-yellow-400 text-yellow-900" : "bg-red-800 text-red-100"}`}
            >
              {user?.role}
            </span>
          </div>
